...
#### Hard Skills
Minhas Hard Skills utilizadas nesse semestre:
- Front-end (JAVA): Consigo fazer com autonomia 
- Pacote Office: Consigo fazer com autonomia
- GitHub: Consigo fazer com autonomia
- Back-End (JAVA): Preciso de colaboração
- Prototipagem: Consigo fazer com autonomia 
...
#### Contribuições Pessoais
Nesse projeto atuei como Product Owner onde fui responsável por definir e priorizar os requisitos do cliente. Meu papel visava garantir as necessidades e expectativas do cliente fazendo com que meu time compreendesse e executasse de maneira eficaz. 
...
- Documentação: Documento que contempla as informações do projeto. Usando: Github e pacote Office. 

- Apresentação: Fiquei responsável pela criação da apresentação, onde no final de cada sprint, havia uma demonstração do projeto para o cliente e para os professores.
Usando: Canva. 


#### Hard Skills
Minhas Hard Skills utilizadas nesse semestre:
- Front-End: Consigo fazer com colaboração
- Pacote Office: Consigo fazer com autonomia
- GitHub: Consigo fazer com autonomia
- BackEnd: Preciso de colaboração
- Prototipagem: Consigo fazer com autonomia
...
- Telas para exemplo: Produzi telas de exemplo que demonstravam visualmente as funcionalidades, facilitando a compreensão dos desenvolvedores para a programação.
